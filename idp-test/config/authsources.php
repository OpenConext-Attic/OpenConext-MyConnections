...
//            'urn:oid:0.9.2342.19200300.100.1.1' => array('test-student'),   // uid
            'commonName' => 'Student Pass',          // displayName
            'displayName' => 'Student Pass',          // displayName
            'mail'      => 'student@example.com',   // email (also used for EPTI)
...
//            'urn:oid:0.9.2342.19200300.100.1.1' => array('foobar'),         // uid
            'commonName'             => 'Foo Bar',               // displayNameu
            'mail'                    => 'foo@bar.com',           // email (also used for EPTI)
            'schacHomeOrganization'   => 'Example Inc',           // schacHomeOrganisation
        ),
        'reinier:reinier' => array(
//            'urn:oid:0.9.2342.19200300.100.1.1' => array('foobar'),         // uid
            'displayName'             => 'Reinier Kip',               // displayName
            'mail'                    => 'reinier@ibuildings.nl',           // email (also used for EPTI)
            'schacHomeOrganization'   => 'Ibuildings bv',           // schacHomeOrganisation
            'commonName'              => "Reinier Kip",             // commonName
        ),
        'daan:daan' => array(
//            'urn:oid:0.9.2342.19200300.100.1.1' => array('foobar'),         // uid
            'displayName'             => 'Daan van Renterghem',               // displayName
            'mail'                    => 'rkip@ibuildings.nl',           // email (also used for EPTI)
            'schacHomeOrganization'   => 'Ibuildings bv',           // schacHomeOrganisation
            'commonName'              => 'Daan van Renterghem',             // commonName
        ),
        'sraa:sraa' => array(
            'commonName'            => 'SRAA Account', // displayName
            'mail'                  => 'rkip+sraa@ibuildings.nl',     // email (also used for EPTI)
            'schacHomeOrganization' => 'Ibuildings bv',             // schacHomeOrganisation
        ),
        'sms:sms' => array(
            'commonName'            => 'SMS Account', // displayName
            'mail'                  => 'rkip+sms@ibuildings.nl',     // email (also used for EPTI)
            'schacHomeOrganization' => 'Ibuildings bv',             // schacHomeOrganisation
        ),
        'yubi:yubi' => array(
            'commonName'            => 'Mr. Yubi', // displayName
            'mail'                  => 'rkip+yubikey@ibuildings.nl',     // email (also used for EPTI)
            'schacHomeOrganization' => 'Ibuildings bv',             // schacHomeOrganisation
        ),
        'u2f:u2f' => array(
            'commonName'            => 'Mr. U2F', // displayName
            'mail'                  => 'rkip+u2f@ibuildings.nl',     // email (also used for EPTI)
            'schacHomeOrganization' => 'Ibuildings bv',             // schacHomeOrganisation
        ),
    ),
